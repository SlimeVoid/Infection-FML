...
import slimevoid.infection.actions.ActionEntityChicken;
import slimevoid.infection.actions.ActionEntityCreeper;
import slimevoid.infection.actions.ActionEntityMetamorph;
import slimevoid.infection.actions.ActionEntityPigZombie;
import slimevoid.infection.actions.ActionEntityWolf;
...
public class Infection {
	...
	public void init() {
		...
		for (int i = 0; i < 255; i++) {
			infectedBlock[i] = new InfectedBlock(InfectionMod.INFECTED.blockID, 2);
		}
		infectedBlock[InfectionMod.INFECTED.blockID] = new InfectedBlock(-1);
		infectedBlock[InfectionMod.INFECTED_SKY.blockID] = new InfectedBlock(-1);
		infectedBlock[InfectionMod.INFECTED_WOOD.blockID] = new InfectedBlock(-1);
		infectedBlock[InfectionMod.INFECTED_WATER.blockID] = new InfectedBlock(-1);
		infectedBlock[InfectionMod.INFECTED_LEAVES.blockID] = new InfectedBlock(-1);
		...
		infectedBlock[Block.leaves.blockID] = new InfectedBlock(InfectionMod.INFECTED_LEAVES.blockID, 1);
		infectedBlock[Block.wood.blockID] = new InfectedBlock(InfectionMod.INFECTED_WOOD.blockID, 4);
		infectedBlock[Block.dirt.blockID] = new InfectedBlock(2);
		infectedBlock[Block.grass.blockID] = new InfectedBlock(2);
		infectedBlock[Block.waterMoving.blockID] = new InfectedBlock(InfectionMod.INFECTED_WATER.blockID, 1);
		infectedBlock[Block.waterStill.blockID] = new InfectedBlock(InfectionMod.INFECTED_WATER.blockID, 1);
		...
		infectedBlock[InfectionMod.GROUND_DIAMOND.blockID] = new InfectedBlock(-1);
	...
	public void addEntitySpawn(ChunkCoordinates coord) {
		...
		if (!entitySpawn.contains(coord) && b1 == InfectionMod.INFECTED.blockID && b2 == 0) {
