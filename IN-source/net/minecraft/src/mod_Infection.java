...
import net.minecraft.slimevoid.cutscene.GuiCutscene;
...
import net.minecraft.slimevoid.infection.blocks.RenderDiamond;
import net.minecraft.slimevoid.infection.blocks.RenderSpawnBlock;
import net.minecraft.slimevoid.infection.blocks.TileEntityDiamond;
import net.minecraft.slimevoid.infection.blocks.TileEntitySpawnBlock;
import net.minecraft.slimevoid.infection.cutscene.CutsceneSpec;
import net.minecraft.slimevoid.infection.cutscene.CutsceneStart;
import net.minecraft.slimevoid.infection.entities.EntityInfectedArrow;
import net.minecraft.slimevoid.infection.entities.RenderInfectedArrow;
import net.minecraft.slimevoid.infection.fx.TextureInfectedWaterFX;
import net.minecraft.slimevoid.infection.gui.GuiLobby;
import net.minecraft.slimevoid.infection.gui.GuiOverlayInfection;
...
import net.minecraft.slimevoid.infection.mobs.EntityInfectedWormRenderer;
...
public class mod_Infection {
	
	public void Infection() {
		instance = this;
		gamemode = new InfectionGamemode("Infection", 4);
		
		INFECTED = new BlockInfected(151).setHardness(100F).setStepSound(Block.soundGrassFootstep);
		INFECTED_SKY = new BlockInfectedSky(152).setHardness(100F);
		INFECTED_WOOD = new BlockInfectedWood(153).setHardness(100F);
		INFECTED_WATER = new BlockInfectedWater(154).setHardness(100F).setStepSound(Block.soundGrassFootstep);
		INFECTED_LEAVES = new BlockInfectedLeaves(156).setHardness(.2F);
		SPAWN = new BlockSpawn(157, 20).setHardness(-1);
		GROUND_DIAMOND = new BlockGroundDiamond(158).setHardness(-1);
