...
public class EntityInfectedWaterFX extends EntityFX
{
    private float lavaParticleScale;

    public EntityInfectedWaterFX(World par1World, double par2, double par4, double par6)
    {
