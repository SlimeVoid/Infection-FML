package net.minecraft.slimevoid.infection.entities;
...
public class EntityInfectedArrow extends Entity {
	private int xTile;
	private int yTile;
	private int zTile;
	private int inTile;
	...
	public EntityInfectedArrow(World par1World, double par2, double par4,
			double par6) {
		super(par1World);
		xTile = -1;
		yTile = -1;
	...
	public EntityInfectedArrow(World par1World, EntityLiving par2EntityLiving,
		...
		if (movingobjectposition != null) {
			if (movingobjectposition.entityHit != null) {
				...
				if (movingobjectposition.entityHit instanceof EntityPlayer) {
					EntityPlayer p = (EntityPlayer) movingobjectposition.entityHit;
					p.addPotionEffect(new PotionEffect(Potion.poison.id,
							2 * 20, 0));
				}
				...
				while (!InfectionGamemode.infection.isInfected(xTile, yTile,
						zTile)) {
					mod_Infection.instance.gamemode.infect(xTile, yTile, zTile,
							0, inTile, 200);
				}
