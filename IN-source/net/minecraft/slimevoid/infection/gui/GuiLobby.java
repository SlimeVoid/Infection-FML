...
public class GuiLobby extends GuiScreen {
	...
	private void drawTimer() {
		...
		String str;
		long timer = mod_Infection.instance.getSessionStartTime();
	...
	private void drawPlayerList(int playersWidth) {
        ...
        for(int i = 0; i < list.size(); i ++) {
        	...
        	int hPerName = 15;
        	fontRenderer.drawStringWithShadow(str, margin + 4, margin + 4 + i * hPerName, mod_Infection.instance.isPlayerReady(str) ? 0xFFFFFF : 0xFF2020);
