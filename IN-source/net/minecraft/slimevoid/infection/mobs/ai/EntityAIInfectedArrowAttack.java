package net.minecraft.slimevoid.infection.mobs.ai;
...
public class EntityAIInfectedArrowAttack extends EntityAIBase
{
    World worldObj;
    ...
    public EntityAIInfectedArrowAttack(EntityLiving par1EntityLiving, float par2, int par3, int par4)
    {
        rangedAttackTime = 0;
        field_48177_f = 0;
    ...
    public boolean shouldExecute()
    {
        ...
        {
        	entityliving = worldObj.getClosestPlayerToEntity(entityHost, -1);
        }
    ...
    public void updateTask()
    {
        ...
        {
            entityHost.getNavigator().tryMoveToEntityLiving(attackTarget, field_48180_e);
        }
        else
        {
    ...
    private void doRangedAttack()
    {
        if (rangedAttackID == 1)
        {
        	EntityInfectedArrow entityarrow = new EntityInfectedArrow(worldObj, entityHost, attackTarget, 1.6F, 12F);
