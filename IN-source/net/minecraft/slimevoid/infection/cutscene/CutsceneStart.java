...
import net.minecraft.slimevoid.cutscene.Scene;
import net.minecraft.slimevoid.cutscene.Scene3D;
import net.minecraft.slimevoid.cutscene.Waypoint;
import net.minecraft.slimevoid.cutscene.effect.Effect2D;
import net.minecraft.slimevoid.cutscene.effect.Effect2DColor;
import net.minecraft.slimevoid.cutscene.effect.Effect2DFade;
...
public class CutsceneStart extends Cutscene {
	...
	protected void initScenes() {
		...
		ChunkCoordinates cc = mod_Infection.infectionPos;
